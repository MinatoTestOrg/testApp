...
public class TablenwBaseService<T extends TablenwBase> extends BaseBusinessLogic<T>
		implements ITablenwBaseService<T> {
	...
	public TablenwBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Tablenw", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Tablenw", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Tablenw", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
